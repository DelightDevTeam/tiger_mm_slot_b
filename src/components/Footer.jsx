  ...
  const follow = [
    {
      id: 1,
      title: 'Facebook',
      icon: <FaFacebookF size={22} color='#2B1C40 ' />,
      link: '/',
    },
    {
      id: 2,
      title: 'Telegram',
      icon: <FaTelegramPlane size={22} color='#2B1C40 ' />,
      link: '/',
    },
    {
      id: 3,
      title: 'Instagram',
      icon: <FaInstagram size={22} color='#2B1C40 ' />,
      link: '/',
    },
  ];
  return (
    <footer className='pt-5 pb-4 px-2 px-md-5 mb-5 mb-lg-0'>
      <div className=' '>
        <h2 className='mb-4 footerTitle'>Tiger MM Slot</h2>
        <p>
          Welcome to our website! As one of the most popular gambling platforms
          in Asia, we offer a diverse range of gaming experiences. Whether
          you're a fan of slot machines, fishing games, sports betting, or live
          casino games, we have something for you.
        </p>
        {/* {!auth && (
          <NavLink to={'/login'}>
              ...
              >
                {games.map((item) => {
                  return (
                    <NavLink
                      className={
                        'footerGame gap-2  d-flex align-items-center justify-content-center '
                      }
                      to={item.link}
                      key={item.id}
                    >
